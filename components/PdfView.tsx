...
// gsutil cors set cors.json gs://ai-to-pdf-file-chat.appspot.com
//gsutil cors set cors.json gs://chat.appspot.com
// go here >> https://console.cloud.google.com
//create new file in editor calls cors.json 
//run >> gsutil cors set cors.json gs://ai-to-pdf-file-chat.appspot.com
//https://firebase.google.com/docs/storage/web/download-files#cors_configuration 

//servicer worker needed 
pdfjs.GlobalWorkerOptions.workerSrc = `//unpkg.com/pdfjs-dist@${pdfjs.version}/build/pdf.worker.min.mjs`

function PdfView({url}: {url: string}){
    //UseStates to manage view of the PDF document
    ...
    return (
        <div className="flex flex-col justify-center items-center">
            <div className="sticky top-0 z-50 bg-gray-100 p-2 rounded-b-lg">
                ...
                <Button variant="outline" disabled={pageNumber === 1} onClick={() => {if (pageNumber > 1){
